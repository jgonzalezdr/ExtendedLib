...
#ifndef EXTENDEDLIB_FormastString_h__
#define EXTENDEDLIB_FormastString_h__
 ...
 */
EXTENDEDLIB_EXPORT std::string vformat( const char *fmt, va_list ap ) ATTR_PRINTF_1_0;
 ...
 */
EXTENDEDLIB_EXPORT std::string format( const char *fmt, ... ) ATTR_PRINTF_1_2;
 ...
 */
EXTENDEDLIB_EXPORT std::string format_hex( const std::vector<uint8_t>& data, const std::string &indent, const std::string &separator,
 ...
 * @return
 */
EXTENDEDLIB_EXPORT std::string format_hex( const std::vector<uint8_t>& data, unsigned int indent = 0, unsigned int separator = 1,
                                           unsigned int bytes_per_line = 16 );
