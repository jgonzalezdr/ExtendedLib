...
#ifndef EXTENDEDLIB_log_h__
#define EXTENDEDLIB_log_h__
 ...
 */
class EXTENDEDLIB_EXPORT log_handler
{
public:
...
template class EXTENDEDLIB_EXPORT ext::shared_ptr<log_handler>;

/**
 * The log singleton class provides access to the log management functionalities.
 */
class EXTENDEDLIB_EXPORT log
{
public:
    ///@cond INTERNAL
    /**
