...
#ifndef EXTENDEDLIB_MSW_callback_dispatcher_h__
#define EXTENDEDLIB_MSW_callback_dispatcher_h__
 ...
 */
#define EXTENDEDLIB_DEFAULT_WM_EVENT ( WM_USER + 13500 )
 ...
 */
class EXTENDEDLIB_EXPORT callback_dispatcher
{
public:
    /**
